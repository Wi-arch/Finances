...
public class CardMaker implements Command {
	...
	public Map<String, Object> execute(Map<String, Object> request) {
		...
		String holderLogin = null;
		if (request.get("login") instanceof String) {
			holderLogin = (String) request.get("login");
		}
		...
		try {
			cardService.createCard(number, currency, holderLogin);
